...
public class Player implements Comparable<Player>, Serializable {
  ...
  public String stats(int maxLen) {
    String space = normalizeSpace(maxLen, this.toString());
    return String.format("%s%s | Height: %d | Has experience? %s", 
                                new Object[] {
                                   this.toString(),
                                   space,
                                   this.getHeightInInches(),
                                   (this.isPreviousExperience() ? "Yes" : "No ")
                                 }
                                );
  }
